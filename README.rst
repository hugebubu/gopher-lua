...
.. image:: https://pkg.go.dev/badge/github.com/hugebubu/gopher-lua.svg
    :target: https://pkg.go.dev/github.com/hugebubu/gopher-lua

.. image:: https://github.com/hugebubu/gopher-lua/workflows/test/badge.svg?branch=master&event=push
    :target: https://github.com/hugebubu/gopher-lua/actions?query=workflow:test

.. image:: https://coveralls.io/repos/github/hugebubu/gopher-lua/badge.svg?branch=master
    :target: https://coveralls.io/github/hugebubu/gopher-lua

.. image:: https://badges.gitter.im/Join%20Chat.svg
    :alt: Join the chat at https://gitter.im/hugebubu/gopher-lua
    :target: https://gitter.im/hugebubu/gopher-lua?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge
...
There are some benchmarks on the `wiki page <https://github.com/hugebubu/gopher-lua/wiki/Benchmarks>`_ .
...
.. code-block:: bash
   ...
   go get github.com/hugebubu/gopher-lua
...
.. code-block:: go
   ...
   import (
       "github.com/hugebubu/gopher-lua"
   )
...
Refer to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ and `Go doc <http://godoc.org/github.com/hugebubu/gopher-lua>`_ for further information.

Note that elements that are not commented in `Go doc <http://godoc.org/github.com/hugebubu/gopher-lua>`_ equivalent to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ , except GopherLua uses objects instead of Lua stack indices.
...
Refer to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ and `Go doc(LState methods) <http://godoc.org/github.com/hugebubu/gopher-lua>`_ for further information.
...
Refer to `Go doc(LState methods) <http://godoc.org/github.com/hugebubu/gopher-lua>`_ for further information.
...
.. code-block:: bash
   ...
   go get github.com/hugebubu/gopher-lua/cmd/glua
...
How to Contribute
----------------------------------------------------------------
See `Guidlines for contributors <https://github.com/hugebubu/gopher-lua/tree/master/.github/CONTRIBUTING.md>`_ .
...
- `gluamapper <https://github.com/hugebubu/gluamapper>`_ : Mapping a Lua table to a Go struct
- `gluare <https://github.com/hugebubu/gluare>`_ : Regular expressions for gopher-lua
